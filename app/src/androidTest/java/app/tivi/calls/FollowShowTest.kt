...
class FollowShowTest : BaseDatabaseTest() {
    private lateinit var followShowCall: FollowShowCall
    ...
    override fun setup() {
        ...
        followShowCall = FollowShowCall(testCoroutineDispatchers, followShowsDao, seasonFetcher)
    }
